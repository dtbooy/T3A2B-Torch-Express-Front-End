...
const Search = () => {
  ...
  const handleSubmit = (e) => {
    ...
    e.preventDefault();
    e.stopPropagation();
    const searchQuery = `?${pickup && "pickup="+pickup}&${dropoff && "dropoff="+dropoff}&${date && "date="+date})`
  ...
  return (
    <Container>
    <h2>Search</h2>
    {/* <SearchForm handleSubmit={handleSubmit} locations={locations}/> */}
    <Form>
        <Row className="mb-3">
        <Col sm>
            <Form.Group as={Col} controlId="pickup">
            <Form.Label>Pickup Location</Form.Label>
            <Form.Select value={pickup} onChange={(e) => setPickup(e.target.value)}>
